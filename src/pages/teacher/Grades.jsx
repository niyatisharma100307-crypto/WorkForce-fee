...
export default function TeacherGrades() {
  ...
  if (!courseClasses.length) return <><div className="app-header"><div><h1>Grade Card</h1><div className="sub">Upload marks for a specific course class.</div></div></div><div className="empty-state">No course classes assigned yet. <Link to="/teacher/roster">Add Students →</Link></div></>;
