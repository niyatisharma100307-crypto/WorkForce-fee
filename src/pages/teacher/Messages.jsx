...
export default function TeacherMessages() {
  ...
  if (!courseClasses.length) return <><div className="app-header"><div><h1>Conversations</h1><div className="sub">Private threads are separated by course class.</div></div></div><div className="empty-state">No course classes assigned yet.</div></>;
  ...
  return <>
    ...
    {!students.length ? <div className="empty-state">No students assigned to this course class. Add them from Add Students.</div> : <div className="chat-shell">
